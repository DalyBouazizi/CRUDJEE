    ...
    <div class="container">
          <form action="Updateuser" method="post">
            ...
            <div class="input-group">
                ...
                <input type="text" placeholder="Enter your first name" id="contact-name" name="firstName" value="${employee.firstName}">
                <span id="name-error"></span>
            </div>
            
            <div class="input-group">
                <label >Last name</label>
                <input type="text" placeholder="Enter your last name" id="contact-name"  name="lastName" value="${employee.lastName}" >
                <span id="email-error"></span>
            </div>
            <div class="input-group">
                <label >Username</label>
				<input type="text" placeholder="Enter your username"  name="username" id="username"  value="${employee.userName} ">
                <span id="message-error"></span>
            </div>
            <div class="input-group">
                <label >Adress</label>
				<input type="text" placeholder="Enter your adress"  name="address" id="adress"  value="${employee.address}" >
                <span id="message-error"></span>
            </div>
             <div class="input-group">
                <label >Password</label>
				<input type="password" placeholder="Enter your password" name="password"   id="password" value="${employee.password}">
            ...
            <div class="input-group">
                <label >Role</label>
                <input type="tel" placeholder="12 345 678" id="contact-phone" name="role"   value="${employee.role}" >
                <span id="phone-error"></span>
            </div>
